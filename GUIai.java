...
class GUIai extends JFrame
{
	...
	//	bottomShipLabelPanel.add(aircraftCarrierLabel);
		...
		*/
		...
		JButton viewMap = new JButton("Veiw Influence Map");
		viewMap.addMouseListener(new ShowButtonAction(this));
		rotatePanel.add(viewMap);
	...
	//	}
			//this.playerTurn();	
	out=out + playerTurn;	/*playerHome.allShipsPlaced()*/;
		return out;
	}
...
class AttackMousePressListener extends MouseAdapter
{
	...
	public AttackMousePressListener(AttackPanel p, GUIai gui2)
	{
		a=p;
		gui=gui2;
	}
...
class HomeMousePressListener extends MouseAdapter
{
	...
	public HomeMousePressListener(HomePanel p, GUIai gui2)
	{
		a=p;
		gui=gui2;
	}
...
class RotateButtonAction extends MouseAdapter
{
	...
	public RotateButtonAction(GUIai gui2)
	{
...
class HideButtonAction extends MouseAdapter
{
	...
	public HideButtonAction(GUIai gui2)
	{
...
class ShowButtonAction extends MouseAdapter
{
	...
	public ShowButtonAction(GUIai gui2)
	{
...
class NewButtonAction extends MouseAdapter
{
	...
	public NewButtonAction(GUIai gui2)
	{
